...
repl_acct_t *ra_add (char *server, char *account, repl_level_t level, int mand, int is_updatable);
...
repl_subscriber_t *repl_save_subscriber (repl_acct_t * ra, char *subscriber, int level, int valid);
