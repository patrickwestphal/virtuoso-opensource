...
typedef struct index_type_s
{
  ...
  void (*iext_is_match) (iext_index_t iext, iext_txn_t txn, char **query, void *params, int n_matches, int *n_match_ret,
      int64 * ids, int *ret, int64 * score_ret, caddr_t * err_ret);
